...
🛠️ Como Funciona
A estrutura do projeto conta com três elementos principais:

Botão "Ligar": Executa uma instrução JavaScript que altera o caminho da imagem (src) para pic_bulbon.gif.

Imagem (<img>): Exibe o estado atual da lâmpada (inicialmente pic_bulboff.gif).

Botão "Desligar": Altera o caminho da imagem (src) de volta para pic_bulboff.gif.
